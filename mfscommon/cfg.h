...
_CONFIG_MAKE_PROTOTYPE(str,char*);  //char *cfg_getstr(const char *name, const char *def);
...
//
_CONFIG_MAKE_PROTOTYPE(uint32,uint32_t);//uint32_t cfg_getuint32(const char *name,const uint32_t def)
